...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var name = x3.name$2;
      var this$1 = references.iterator__sc_Iterator();
      var res = true;
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  if (($uD(delta.apply__O()) < 0)) {
    ...
    var delta_sqrt = $uD($g["Math"]["sqrt"](x));
    $m_Lcalculator_Signal$();
    var expr$2 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2$1, b$2$1, delta_sqrt$1) {
      return (function() {
        var array$1 = [(((-$uD(b$2$1.apply__O())) + delta_sqrt$1) / (2 * $uD(a$2$1.apply__O()))), (((-$uD(b$2$1.apply__O())) - delta_sqrt$1) / (2 * $uD(a$2$1.apply__O())))];
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  if ((($uI(remainingCharsCount.apply__O()) >= 0) && ($uI(remainingCharsCount.apply__O()) <= 14))) {
    $m_Lcalculator_Signal$();
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
      return "orange"
    }));
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, x$1) {
    return (function() {
      return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr($as_Lcalculator_Signal(x$1.$$und2$f).apply__O()), $as_sci_Map(arg$outer.namedExpressions$1$f.$$minus__O__sc_Map(x$1.$$und1$f)))
    })
  })(this, x));
